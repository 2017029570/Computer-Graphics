...
def drawCube_glDrawArray():
    global gVertexArraySeparate, gIndexArray, gNormalArray
...
def main():
    ...
    if not glfw.init():
        return
    window = glfw.create_window(480,480,'2017029570-8-2', None,None)
    if not window:
        glfw.terminate()
        return
    ...
    gVertexArraySeparate,gNormalArray,gIndexArray = createVertexArraySeparate()
